...
export function WizardLayout({
    ...
    return (
        <div className="min-h-screen pt-24 pb-12 flex flex-col relative overflow-hidden">
            ...
            <div className="fixed top-20 left-0 right-0 z-40 px-6 max-w-3xl mx-auto w-full">
            ...
            {/* Main Content Area */}
            <main className="flex-grow flex items-center justify-center container max-w-3xl mx-auto px-6 mt-8">
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="w-full"
                    >
                        <div className="glass-panel p-6 md:p-10 rounded-2xl w-full">
                            {children}
                        </div>
                    </motion.div>
                </AnimatePresence>
            ...
            {/* Navigation Bar */}
            <div className="fixed bottom-0 left-0 right-0 p-6 bg-background/80 backdrop-blur-md border-t border-white/10 z-40">
                <div className="max-w-3xl mx-auto flex items-center justify-between">
                    <button
                        onClick={handlePrev}
                        disabled={currentStep === 1 || isGenerated}
                        className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-all ${currentStep === 1 || isGenerated
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-8 py-3 rounded-full font-bold relative overflow-hidden group transition-all ${disableNext || isGenerated ? "opacity-50 cursor-not-allowed" : "hover:scale-105"
                            }`}
                    >
                ...
                {isGenerated && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ scale: 1, y: 0 }}
                            className="bg-background border border-white/10 shadow-2xl p-8 rounded-3xl max-w-lg w-full text-center relative overflow-hidden glass-panel"
                        >
                            ...
                            <h2 className="text-3xl font-bold mb-4">Magic Created! ✨</h2>
